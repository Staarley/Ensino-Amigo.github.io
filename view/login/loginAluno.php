    ...
    <head>
        ...
        <link rel="stylesheet" href="../css/loginAlunoStyle.css">
        <link rel="shortcut icon" href="../image/logo.ico" type="image/x-icon">
        <title>login | Ensino Amigo</title>
    </head>
    <body>
        <div class="container">
            ...
            <div class="card">
                <img src="../image/logomenor.png" alt="logoMenor" id="logoMenor">
                <div class="arcoIris">
                    <div class="azul">
                        <div class="amarelo">
                            <div class="vermelho">
            ...
            <div class="formContainer">
                <form class="formCadastro" method="post" action="../../model/autenticaAluno.php">
                    ...
                    <img src="../image/logomenor.png" alt="logo" id="logoMenor" title="Ensino Amigo">
